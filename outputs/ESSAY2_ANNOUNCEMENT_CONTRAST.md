...
## LEVEL 1 — Announcement window (information content): abnormal-vol elevation [-4,+4] vs [-25,-5], identical machinery, same firms
  ...
  BREACH notifications: -0.0935 daily pp (SE 0.0503, 95% CI [-0.1937, +0.0066], N=331, 82 firms)
  CONTRAST (breach minus earnings, firm-clustered): -0.8736 (SE 0.0775, 95% CI [-1.0277, -0.7194], t=-11.3)
