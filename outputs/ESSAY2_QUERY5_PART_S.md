...
## P — PRC provenance diagnostic
  Notification records by year (1,054 universe) and treated share of events (489):
    ...
    2023: records 163 | events  66 | treated share 21%
    2024: records 188 | events  40 | treated share 40%
    2025: records  36 | events   9 | treated share 0%
  2019 frame break (media-curated -> statutory filings): treated share 20.9% pre-2019 vs 27.8% 2019+ (Welch t=-1.77, p=0.0777). No fall at the frame change — the H5 mechanism leaves no visible mark in treated representation.
...
## B3 addendum — Dropped vs retained (489 -> 333)
  firm_size_log: retained mean 10.24 (n=333) vs dropped 10.82 (n=13); standardized diff -0.43 (Imbens denominator sqrt((S2t+S2c)/2))
  return_volatility_pre: retained mean 29.08 (n=333) vs dropped 37.30 (n=22); standardized diff -0.30 (Imbens denominator sqrt((S2t+S2c)/2))
