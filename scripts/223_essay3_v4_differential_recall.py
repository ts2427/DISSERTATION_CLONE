...
Outputs: outputs/essay3_v4/d3_misses_by_treatment.csv, d3_recall_by_treatment.csv, 198_recall.log

REBUILD V4 NOTE
---------------
Copied from scripts/198_essay3_q2_differential_recall.py. Only the data sources move; the method does not.
