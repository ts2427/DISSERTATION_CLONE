...
departure.
Outputs: outputs/essay3_v4/d3_audit_agreement.csv, d3_audit_recall_by_stratum.csv, d3_audit_disagreements.csv,
         d3_exhibit_only_candidates.csv, ADJUDICATION.xlsx (adds tab audit_v2), 201_audit.log

REBUILD V4 NOTE
---------------
Copied from scripts/201_essay3_q2_recall_audit_scoring.py. Only the data sources move; the method does not.
