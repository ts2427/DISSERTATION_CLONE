...
Outputs: outputs/essay3_v4/validation_ids_r2.csv, VALIDATION_SHEET_R2.xlsx, validation_classifier_HIDDEN_R2.csv

REBUILD V4 NOTE
---------------
Copied from scripts/196_essay3_q2_validation_sheet_r2.py. Only the data sources move; the method does not.
