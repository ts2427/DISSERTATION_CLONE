...
Outputs: outputs/essay3_v4/audit_ids.csv, VALIDATION_SHEET_AUDIT.xlsx, validation_classifier_HIDDEN_AUDIT.csv

REBUILD V4 NOTE
---------------
Copied from scripts/200_essay3_q2_recall_audit_sheet.py. Only the data sources move; the method does not.
