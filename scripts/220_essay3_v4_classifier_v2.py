...
Input : outputs/essay3_v4/b_scope_filings.csv (+ the documents it names under
...
Rules (all in this file; nothing learned):
  ...
  C3 outcome - per event and anchor (reported_date primary, breach_date sensitivity):
               ...
               in [t0-730d, t0-181d].
Outputs: outputs/essay3_v4/c_filing_codes.csv, c_person_rows.csv, c_sections.csv,
...
REBUILD V4 NOTE
---------------
Copied from scripts/195_essay3_q2_classifier_v2.py. Only the data sources move; the method does not.
...
if __name__ == '__main__':
    ...
    (OUT / '220_classifier.log').write_text('\n'.join(L) + '\n', encoding='utf-8')
