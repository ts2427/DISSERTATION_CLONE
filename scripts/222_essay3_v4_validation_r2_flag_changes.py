...
Outputs: outputs/essay3_v4/d3_r2_agreement.csv, d3_r2_disagreements.csv, ADJUDICATION.xlsx,
         e_flag_changes_v1_v2.csv, 197_r2.log

REBUILD V4 NOTE
---------------
Copied from scripts/197_essay3_q2_validation_r2_flag_changes.py. Only the data sources move; the method does not.
