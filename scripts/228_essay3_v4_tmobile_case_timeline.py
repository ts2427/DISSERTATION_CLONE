...
Outputs: outputs/essay3_v4/g6_case_table.csv, g6_restatement_dated.csv, tmobile_timeline.csv, 203_case.log

REBUILD V4 NOTE
---------------
Copied from scripts/203_essay3_q2_tmobile_case_timeline.py. Only the data sources move; the method does not.
