...
print("    Breach data (1,054 records)")
print("    CRSP daily returns (611,119 observations)")
print("    Compustat fundamentals")
print("    Market indices")
print("    Disclosure timing")
...
# FCC classification (add if not already present)
...
# Complete data flag
if 'has_complete_data' not in breach_df.columns:
...
print(f"\n--- Data Coverage ---")
if 'total_cves' in breach_df.columns:
...
print(f"\n--- FCC Classification ---")
if 'fcc_reportable' in breach_df.columns:
